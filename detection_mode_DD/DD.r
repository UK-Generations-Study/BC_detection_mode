...
DD <- create_dictionary(df, var_labels = dmode_labels, file = "C:/Users/MBrayley/OneDrive - The Institute of Cancer Research/Work/GitHub/BC_detection_mode/detection_mode_DD.xlsx")
